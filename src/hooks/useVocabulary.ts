    ...
    async (topic: string, subCategory?: string, forceRefresh = false) => {
      try {
        ...
        const simpleFetchers: Record<string, () => Promise<VocabularyItem[]>> = {
          ...
          culture: () => vocabularyCacheService.getCulture({ forceRefresh }) as Promise<VocabularyItem[]>,
          ...
          work: () => vocabularyCacheService.getWork({ forceRefresh }) as Promise<VocabularyItem[]>,
        ...
        const categoryFetchers: Record<string, (c: string) => Promise<VocabularyItem[]>> = {
          ...
          work: (c) => vocabularyCacheService.getWorkByCategory(c, { forceRefresh }) as Promise<VocabularyItem[]>,
        };
