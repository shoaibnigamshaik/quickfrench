                ...
                {!showResult && (
                    <div className="mt-3 flex items-center justify-center gap-3">
                        ...
                        <Button
                            type="button"
                            onClick={onIDontKnow}
                            className="inline-flex items-center px-4 py-2.5 text-sm md:text-base rounded-lg font-medium border focus:outline-none focus:ring-2 focus:ring-(--primary-600) focus:ring-offset-2 focus:ring-offset-(--card)"
                            style={{
                                backgroundColor: 'var(--card)',
