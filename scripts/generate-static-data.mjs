...
async function run() {
    ...
    const simpleEndpoints = [
        ...
        {
            key: 'transportation',
            sql: 'SELECT word, meaning FROM transportation',
        },
    ...
    const grouped = [
        ...
        },
        {
            ...
            categoriesSql:
                'SELECT id, name FROM family_categories ORDER BY name',
            perCategorySql: `SELECT f.word, f.meaning, fc.name as category\n                       FROM family f JOIN family_categories fc ON f.category_id = fc.id\n                       WHERE fc.name = ?`,
        },
        {
            key: 'home',
        ...
        },
        {
            ...
            categoriesSql:
                'SELECT id, name FROM nature_categories ORDER BY name',
        ...
        },
        {
            ...
            categoriesSql:
                'SELECT id, name FROM shopping_categories ORDER BY name',
        ...
        },
        {
            ...
            categoriesSql:
                'SELECT id, name FROM education_categories ORDER BY name',
    ...
    for (const g of grouped) {
        ...
        for (const c of catList) {
            ...
            const pc = await turso.execute({
                sql: g.perCategorySql,
                args: [name],
            });
